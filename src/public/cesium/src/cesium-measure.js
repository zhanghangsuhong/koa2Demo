function log(tag, msg) {
    return console.log(
        '%c' + tag + ' ' + '%c' + msg,  // Console Message
        'color: blue', 'color: black' // CSS Style
    );
}
        ...
        _.prototype = {
            ...
            */
            transformCartesianArrayToWGS84Array: function (cartesianArr) {
                log('cartesianArr：', JSON.stringify(cartesianArr))
                if (this._viewer) {
                    var $this = this
                    return cartesianArr
           ...
           */
            getCatesian3FromPX: function (px) {
                ...
                if (this._viewer && px) {
                    ...
                    for (let i in picks) {
                        ...
                        // log('isOn3dtiles:', isOn3dtiles)
                        // 3dtilset
                        if (isOn3dtiles) {
                            this._viewer.scene.pick(px) // pick
                            cartesian = this._viewer.scene.pickPosition(px);
                            console.log("3dtilset-cartesian：", JSON.stringify(cartesian))
                            if (cartesian) {
                                ...
                                console.log("3dtilset-cartesian转换后：", JSON.stringify(cartesian))
            ...
            getPositionDistance: function (positions) {
                ...
                for (let i = 0; i < positions.length - 1; i++) {
                    ...
                    log('point1cartographic', point1cartographic)
                    log('point2cartographic', point2cartographic)
            ...
            drawLineMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    _handlers.setInputAction(function (movement) {
                        log('movement：', JSON.stringify(movement))
