...
MapConfig.mapInitParams = {
     ...
     */
    imageryViewModels: [
        //{"id":0,"label":"广东影像",className:"imgType",type:5,proxyUrl:'',Url:'/geowebcache/service/wms',credit:'wms服务',layers: 'GD:GDImage',tilingScheme:new Cesium.WebMercatorTilingScheme()},
        //{"id":1,"label":"广东海图",className:"vecType",type:5,proxyUrl:'',Url:'/geowebcache/service/wms',credit:'wms服务',layers: 'GD:SeaMap',tilingScheme:new Cesium.WebMercatorTilingScheme()},
        ...
        { "id": 2, "label": "WMS", className: "imgType", type: 5, proxyUrl: '', Url: '/geowebcache/service/wms', credit: 'wms服务', layers: 'worldMap' },
        //{"id":2,"label":"WMS",className:"imgType",type:5,proxyUrl:'',Url:'/geowebcache/service/wms',credit:'wms服务',layers: 'worldMap',tilingScheme:new Cesium.WebMercatorTilingScheme()},
...
//MapConfig.terrainObj = {type:"CesiumTerrainProvider",url:"/cesium/worldTerrain",requestWaterMask:false,requestVertexNormals:false,proxyUrl:""};//离线地形
/*地图图层菜单目录构造*/
/*
 *name-图层名称
 *layerurl-图层服务配置
...
MapConfig.Layers = [
    ...
    { id: 2, pId: 1, name: "基础空间数据", checked: false },
    {
        ...
        pId: 2,
        name: "视频",//WMS-T
        layerurl: "/geowebcache/service/wms",
